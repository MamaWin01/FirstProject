...
@section('container')
    <div class="container">
        <div class="row">
            <div class="col-6">
                <div class="mt-2">
                    <h1 class="mt-1" style="font-family:Arial">Add
                        <br>
                        <a href="/add/new" class="badge bg-light text-dark my-2" style="opacity: 50%;">New</a>
                        {{-- @if (session('status'))
                        ...
                        @foreach ( $add as $Add)
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                {{ $Add ->name }}
                                <a href="/adds/{{ $Add->id }}" class="badge bg-info ms-2">Detail</a>
                            </li>
                        @endforeach
                    </ul>
