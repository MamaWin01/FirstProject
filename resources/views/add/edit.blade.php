...
@section('container')
    <div class="container">
        <div class="row">
            <div class="col-3">
                <div class="mt-2">
                    <h1 class="mt-1" style="font-family:Arial opacity: 50%;">Edit Data
                        <form method="post" action="/adds/{{ $add->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Insert Name" style="font-family:Arial; opacity:85%;" value="{{ $add->name}}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="id" id="id" class="form-control @error('id') is-invalid @enderror" placeholder="Insert ID" style="font-family:Arial; opacity:85%;" value="{{ $add->data}}">
                                @error('id')
                                <div id="validationServerUsernameFeedback" class="invalid-feedback" style="font-size:15px">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control @error('date') is-invalid @enderror" id="date" name="date" placeholder="DD/MM/YYY" type="text" style="font-family:Arial; opacity:90%; color:rgba(170, 170, 170, 0.925);" value="{{ $add->date}}">
                                @error('date')
                                <div id="validationServerUsernameFeedback" class="invalid-feedback" style="font-size:15px">{{ $message }}</div>
                                @enderror
                            </div>
